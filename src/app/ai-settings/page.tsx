          ...
          <Card className="p-6 border-2 border-[#005cbb]/20">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 p-4 bg-[#f3f3fb] rounded-xl">
                ...
                <div className="flex-1">
                  <p className="font-medium">
                    {aggregatorConnected ? "Aggregator Connected" : "Not Connected"}
                  </p>
                  <p className="text-xs text-[#5b5f6b]">
                    {aggregatorConnected 
                      ? "Posts will be published through your aggregator" 
                      : "Add API key to enable publishing"}
                  </p>
                </div>
                <Button
                  variant="secondary"
                  ...
                  onClick={testAggregatorConnection}
                  isLoading={testingAggregator}
                  disabled={!aggregatorApiKey || !aggregatorApiUrl}
                >
                  Test Connection
                </Button>
              </div>
